    ...
    <CatContainer>
      ...
      <label className="container" htmlFor="check">
        <div className="box-wiggle">
          <div className="box">
            <div className="box-flap box-flap-left"></div>
            <div className="box-flap box-flap-right"></div>
            <div className="box-arrow"></div>
          </div>
          <div className="jasp">
            <div className="jasp-ear jasp-ear-left"></div>
            <div className="jasp-ear jasp-ear-right"></div>
            <div className="jasp-head">
              <div className="jasp-head-lower"></div>
            </div>
            <div className="jasp-face">
              <div className="jasp-eye jasp-eye-left"></div>
              <div className="jasp-eye jasp-eye-right"></div>
              <div className="jasp-snoot"></div>
              <div className="jasp-whisker jasp-whisker-left"></div>
              <div className="jasp-whisker jasp-whisker-right"></div>
            </div>
            <div className="jasp-body"></div>
          </div>
        </div>
        <div className="mouse">
          <div className="mouse-ear"></div>
        </div>
      </label>
    </CatContainer>
  );
